...
@Component
public class CategoryTargetMatchingStrategy implements ChallengeTargetMatchingStrategy {
    ...
    public boolean matches(ChallengeTargetEntity target, HabitEntity habit) {
        return target.getCategoryId() != null && target.getCategoryId().equals(habit.getCategoryId());
    }
}
